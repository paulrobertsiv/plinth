# $ANTLR 3.1.2 Eval.g 2010-04-18 22:47:22
...
class Eval(TreeParser):
        ...
        try:
            try:
                ...
                if alt2 == 1:
                    ...
                    # Eval.g:16:9: ^( '=' ID expr )
                    pass 
                    self.match(self.input, 8, self.FOLLOW_8_in_stat84)
        ...
        try:
            try:
                ...
                if alt3 == 1:
                    ...
                    pass 
                    self.match(self.input, 9, self.FOLLOW_9_in_expr125)
                    ...
                    pass 
                    self.match(self.input, 10, self.FOLLOW_10_in_expr147)
                    ...
                    pass 
                    self.match(self.input, 11, self.FOLLOW_11_in_expr169)
    ...
    FOLLOW_stat_in_prog52 = frozenset([1, 5, 6, 8, 9, 10, 11])
    FOLLOW_expr_in_stat63 = frozenset([1])
    FOLLOW_8_in_stat84 = frozenset([2])
    FOLLOW_ID_in_stat86 = frozenset([5, 6, 9, 10, 11])
    FOLLOW_expr_in_stat88 = frozenset([3])
    FOLLOW_9_in_expr125 = frozenset([2])
    FOLLOW_expr_in_expr129 = frozenset([5, 6, 9, 10, 11])
    FOLLOW_expr_in_expr133 = frozenset([3])
    FOLLOW_10_in_expr147 = frozenset([2])
    FOLLOW_expr_in_expr151 = frozenset([5, 6, 9, 10, 11])
    FOLLOW_expr_in_expr155 = frozenset([3])
    FOLLOW_11_in_expr169 = frozenset([2])
    FOLLOW_expr_in_expr173 = frozenset([5, 6, 9, 10, 11])
